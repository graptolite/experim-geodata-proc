####note:: only works with obsolete OSGB36 long lat coords,
####TODO   but WGS84 should be used instead DONE
...
def wgs2gref(lat,long,H=0,gref_figures=8):
    NEW_DATA = "WGS84"
    OLD_DATA = "Airy1830"
...
def wgs2letter_gref(lat,long,H=0,gref_figures=8):
    a,b = wgs2gref(lat,long,H,gref_figures)
